...
const App: React.FC = () => {
  ...
  const handleLogin = (email, password) => {
    ...
    if (email === 'rajeev@returnzero.space' && password === 'pomocourse') {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col md:flex-row">
      <nav className="md:w-64 bg-gray-900/30 backdrop-blur-sm border-b md:border-b-0 md:border-r border-gray-700 p-4 shrink-0 flex flex-col">
        <div>
        ...
        <div className="mt-auto">
           <button
                ...
                className={`w-full flex items-center space-x-3 p-3 rounded-lg transition-colors duration-200 hover:bg-gray-800`}
              >
                <NavigationIcon icon="logout" />
